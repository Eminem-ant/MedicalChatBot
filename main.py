...
training_dataset = pd.read_csv(r"C:\Users\antri\PycharmProjects\healthchatbot1\Training.csv")
test_dataset = pd.read_csv(r"C:\Users\antri\PycharmProjects\healthchatbot1\Testing.csv")
...
class MainForm(Frame):
    ...
    def createWidget(self):
        self.lblMsg = Label(self, text="Medical Chatbot", bg="#87ceeb", width="300", height="2",
                            font=("Arial Black", 13))
        self.lblMsg.pack()
...
class Login(Frame):
    ...
    def createWidget(self):
        self.lblMsg = Label(self, text="Please enter details below to login", bg="#87ceeb")
        self.lblMsg.pack()
    ...
    def btnLogin_Click(self):
        ...
        if username1 in list_of_files:
            ...
            if password1 in verify:
                ...
                messagebox.showinfo("Failure", "Tumari login details latak gayi \nSushant ki tarah xD")
        else:
            messagebox.showinfo("Failure", "Tumara daakhila nahi hua hai \nkagaz leke aao")
